...
export const ADDONS_CATALOG: AddOnDefinition[] = [
  ...
  // ── Biddaro Inspect ───────────────────────────────────────────────────────
  {
    slug: 'biddaro-inspect',
    name: 'Biddaro Inspect',
    tagline: 'AI inspection reports from field capture',
    description: 'Turn site photos, voice notes, and observations into professional inspection reports in minutes. Biddaro Inspect learns your existing report format and generates client-ready Word and PDF documents automatically.',
    category: 'Productivity',
    icon: '📋',
    price: 19.99,
    pricingType: 'monthly',
    targetRole: 'contractor',
    features: [
      'Mobile field capture (photos, voice, text)',
      'AI generates reports in your format',
      'Word (.docx) and PDF export',
      'Offline capture with cloud sync',
      'Team review workflow before client delivery',
      'Project dashboard with report history',
      'Site plan markup with annotations',
